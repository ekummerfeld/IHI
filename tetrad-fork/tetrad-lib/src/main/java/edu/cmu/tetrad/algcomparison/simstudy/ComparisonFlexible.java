...
/** Modifications of the original comparison class to have more flexible IO capabilities
 * @author arix
 */
public class ComparisonFlexible {
     ...
     */
    public void compareFromFiles(String dataPath, String resultsPath, String outputFileName, Algorithms algorithms,
...
//            }
     ...
     */
    public void saveToFiles(String dataPath,String prefix, Simulation simulation, Parameters parameters) {
        ...
        try {
            ...
            for (SimulationWrapper simulationWrapper : simulationWrappers) {
                ...
                for (int j = 0; j < simulationWrapper.getNumDataModels(); j++) {
                    File file2 = new File(dir1, prefix + "graph." + (j + 1) + ".txt");
                    Graph graph = simulationWrapper.getTrueGraph(j);

                    GraphUtils.saveGraph(graph, file2, false);

                    File file = new File(dir2,   prefix +"data." + (j + 1) + ".txt");
                ...
                PrintStream out = new PrintStream(new FileOutputStream(new File(subdir,  prefix + "parameters.txt")));
