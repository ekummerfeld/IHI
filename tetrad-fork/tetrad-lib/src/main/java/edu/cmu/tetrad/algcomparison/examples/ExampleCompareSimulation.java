...
public class ExampleCompareSimulation {
    public static void main(String... args) {
        ...
        parameters.set("numRuns", 200);
        parameters.set("numMeasures", 100);
        parameters.set("avgDegree", 2);
        parameters.set("sampleSize", 500);
        parameters.set("alpha", .01, .05);
        ...
        statistics.add(new ParameterColumn("num"));
        ...
        statistics.setWeight("F1Arrow", 1.0);
        statistics.setWeight("F1Adj", 1.0);
        ...
        simulations.add(new LinearSineSimulation(new RandomForward()));
